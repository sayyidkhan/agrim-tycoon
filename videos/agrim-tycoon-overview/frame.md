...
description: >
  ...
  are identical and sacred — the green/pink/cream editorial triad, Geist Sans at weight 500
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Geist Sans", cqw: 1.56, weight: 400, lineHeight: 1.38 }
  body-card:{ fontFamily: "Geist Sans", cqw: 1.35, weight: 400, lineHeight: 1.34 }
  ...
  # — display ramp (Geist Sans weight 500, opsz, negative tracking) —
  title-card-sm:{ fontFamily: "Geist Sans", cqw: 2.9, weight: 500, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Geist Sans", cqw: 3.5, weight: 500, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Geist Sans", cqw: 4.4, weight: 500, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Geist Sans", cqw: 5.0, weight: 500, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Geist Sans", cqw: 7.3, weight: 500, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Geist Sans", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Geist Sans", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Geist Sans", cqw: 5.7, weight: 500, lineHeight: 0.92 }
  name:    { fontFamily: "Geist Sans", cqw: 2.3, weight: 600, lineHeight: 1.0 }
...
- **Fonts** — already set to **Geist Sans** (display) / **Geist Mono** (body); ignore any preset font name lingering in prose.
...
Penguin classic or a quiet annual report. One confident voice, **Geist Sans at weight 500**
...
- **Geist Sans weight 500** (opsz, negative tracking) for all display; **serif 400** body; **JetBrains Mono 500** uppercase chrome.
...
- **Squint** — one Geist Sans moment dominates at 3–6× its neighbor; the surface block centers the eye.
...
Two ramps. The **reading/chrome ramp** (Geist Sans **400** body 1.56cqw; JetBrains Mono labels
in px) carries copy + chrome; the **display ramp** (Geist Sans **500** `title-card-sm` 2.9cqw →
...
- Run every display in **Geist Sans weight 500**, opsz, negative-tracked, tight line-height; **body at 400**.
...
- **Type** — Geist Sans **500** display (opsz, negative-tracked) / **400** body; mono uppercase 0.08–0.18em; ≥1.4cqw floor.
...
- **Geist Sans (opsz 8..60) + JetBrains Mono via Google Fonts** — the optical-size axis is critical; a non-opsz fallback flattens the size-aware letterforms. CJK: LXGW WenKai (display) / Noto Serif SC (body) / Noto Sans Mono CJK (chrome).
